...
System.register("./__monkey.entry-BFKvEyld.js", ['vue'], (function (exports, module) {
  'use strict';
  var ref, defineComponent, useAttrs, getCurrentInstance, computed, watch, onMounted, onBeforeUnmount, nextTick, toRef, openBlock, createBlock, Teleport, unref, withDirectives, createElementBlock, mergeProps, withKeys, withModifiers, createCommentVNode, Transition, toHandlers, withCtx, normalizeClass, normalizeStyle, vShow, createVNode, renderSlot, normalizeProps, guardReactiveProps, createElementVNode, reactive, createApp, inject, shallowReactive, markRaw, toRaw, resolveDynamicComponent, createTextVNode, toDisplayString, resolveComponent, Fragment, TransitionGroup, renderList, defineAsyncComponent, Suspense, vModelSelect, getCurrentScope, onScopeDispose, vModelCheckbox, shallowRef, readonly;
  return {
    setters: [module => {
      ref = module.ref;
    ...
    execute: (function () {
      ...
      exports({
        ...
        f: delay2,
        g: getElement,
        o: useBrowserLocation,
        r: useFullscreen,
        u: useElementBounding,
        v: scrollElement,
        w: useStorage
      });
      ...
      function useFullscreen(target, options = {}) {
        ...
        const targetRef = computed(() => {
          var _a;
          return (_a = unrefElement$1(target)) != null ? _a : document2 == null ? void 0 : document2.querySelector("html");
        });
      ...
      */
      ...
      const Io = defineComponent({ inheritAttrs: false }), Ro = exports("R", /* @__PURE__ */ defineComponent({
        ...Io,
...
This will fail in production.`
      ...
      var _hoisted_1$3 = /* @__PURE__ */ createTextVNode(" × ");
      ...
      function render3(_ctx, _cache) {
        return openBlock(), createElementBlock("svg", _hoisted_12$1, _hoisted_3$1);
      }
      ...
      var useToast = exports("h", (eventBus) => {
      ...
      var _GM_addValueChangeListener = exports("n", /* @__PURE__ */ (() => typeof GM_addValueChangeListener != "undefined" ? GM_addValueChangeListener : void 0)());
      var _GM_getValue = exports("j", /* @__PURE__ */ (() => typeof GM_getValue != "undefined" ? GM_getValue : void 0)());
      var _GM_setValue = exports("m", /* @__PURE__ */ (() => typeof GM_setValue != "undefined" ? GM_setValue : void 0)());
      ...
      var DownloadMethod = exports("D", /* @__PURE__ */ ((DownloadMethod2) => {
      ...
      const infiniteScrollSwitch = exports("i", reactive(new GMVariable(GMKey.InfiniteScroll, true)));
      const archiveButtonSwitch = exports("c", reactive(new GMVariable(GMKey.ArchiveButton, true)));
      const highlightSwitch = exports("k", reactive(new GMVariable(GMKey.Highlight, true)));
      const scrollByRowSwitch = exports("s", reactive(new GMVariable(GMKey.ScrollByRow, true)));
      const betterPopupSwitch = exports("e", reactive(new GMVariable(GMKey.BetterPopup, true)));
      const quickDownloadMethod = exports("q", reactive(new GMVariable(GMKey.QuickDownloadMethod, DownloadMethod.Manual)));
      const loadAllGalleryImagesSwitch = exports("l", reactive(new GMVariable(GMKey.LoadAllGalleryImages, true)));
      const multipageViewerEnhancerSwitch = reactive(new GMVariable(GMKey.MultipageViewerEnhancer, true));
      const autoRedirectSwitch = reactive(new GMVariable(GMKey.AutoRedirect, false));
      const preventImageRemovalSwitch = exports("p", reactive(new GMVariable(GMKey.PreventImageRemoval, false)));
      const showJapaneseTitle = reactive(new GMVariable(GMKey.ShowJapaneseTitle, true));
      ...
      const _export_sfc = exports("t", (sfc, props) => {
      ...
      function _sfc_render(_ctx, _cache) {
        return openBlock(), createElementBlock("svg", _hoisted_1$2, _cache[0] || (_cache[0] = [
          createElementVNode("g", null, [
            createElementVNode("path", { d: "M55.931,47.463L94.306,9.09c0.826-0.827,0.826-2.167,0-2.994L88.833,0.62C88.436,0.224,87.896,0,87.335,0   c-0.562,0-1.101,0.224-1.498,0.62L47.463,38.994L9.089,0.62c-0.795-0.795-2.202-0.794-2.995,0L0.622,6.096   c-0.827,0.827-0.827,2.167,0,2.994l38.374,38.373L0.622,85.836c-0.827,0.827-0.827,2.167,0,2.994l5.473,5.476   c0.397,0.396,0.936,0.62,1.498,0.62s1.1-0.224,1.497-0.62l38.374-38.374l38.374,38.374c0.397,0.396,0.937,0.62,1.498,0.62   s1.101-0.224,1.498-0.62l5.473-5.476c0.826-0.827,0.826-2.167,0-2.994L55.931,47.463z" })
          ], -1)
        ]));
      }
          ...
          return (_ctx, _cache) => {
            return openBlock(), createElementBlock("label", _hoisted_1$1, [
              withDirectives(createElementVNode("input", {
                ...
                [vModelCheckbox, modelValueProxy.value]
              ]),
              _cache[1] || (_cache[1] = createElementVNode("span", { class: "switch__slider" }, null, -1))
            ]);
          };
        }
      });
              ...
              default: withCtx(() => [
                createElementVNode("div", _hoisted_1, [
                  createElementVNode("section", _hoisted_2, [
                    _cache[15] || (_cache[15] = createElementVNode("h2", { class: "settings-panel__section-name" }, " Common ", -1)),
                    _cache[16] || (_cache[16] = createElementVNode("hr", null, null, -1)),
                    createElementVNode("div", _hoisted_3, [
                      createVNode(ToggleSwitch, {
                        modelValue: unref(showJapaneseTitle).value,
                        "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => unref(showJapaneseTitle).value = $event)
                      }, null, 8, ["modelValue"]),
                      _cache[14] || (_cache[14] = createElementVNode("h3", { class: "settings__name" }, " Change page title to Japanese (effect on browser/tab title) ", -1))
                    ])
                  ]),
                  createElementVNode("section", _hoisted_4, [
                    _cache[23] || (_cache[23] = createElementVNode("h2", { class: "settings-panel__section-name" }, " Gallery Enhancer ", -1)),
                    _cache[24] || (_cache[24] = createElementVNode("hr", null, null, -1)),
                    createElementVNode("div", _hoisted_5, [
                      createVNode(ToggleSwitch, {
                        modelValue: unref(scrollByRowSwitch).value,
                        "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => unref(scrollByRowSwitch).value = $event)
                      }, null, 8, ["modelValue"]),
                      _cache[17] || (_cache[17] = createElementVNode("h3", { class: "settings__name" }, " Scroll by Row ", -1)),
                      _cache[18] || (_cache[18] = createElementVNode("span", { class: "settings__notice" }, ' *sync with "Front Page Enhancer - Scroll by Row" ', -1))
                    ]),
                    createElementVNode("div", _hoisted_6, [
                      createVNode(ToggleSwitch, {
                        modelValue: unref(betterPopupSwitch).value,
                        "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => unref(betterPopupSwitch).value = $event)
                      }, null, 8, ["modelValue"]),
                      _cache[21] || (_cache[21] = createElementVNode("h3", { class: "settings__name" }, " Better Popup ", -1)),
                      createElementVNode("div", _hoisted_7, [
                        _cache[19] || (_cache[19] = createElementVNode("span", null, ' Action when clicking "Archive Download": ', -1)),
                        withDirectives(createElementVNode("select", {
                          "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => unref(quickDownloadMethod).value = $event)
                        }, [
                          createElementVNode("option", null, toDisplayString(unref(DownloadMethod).Manual), 1),
                          createElementVNode("option", null, toDisplayString(unref(DownloadMethod).HaH_Original), 1),
                          createElementVNode("option", null, toDisplayString(unref(DownloadMethod).HaH_2400), 1),
                          createElementVNode("option", null, toDisplayString(unref(DownloadMethod).Direct_Origin), 1),
                          createElementVNode("option", null, toDisplayString(unref(DownloadMethod).Direct_Resample), 1)
                        ], 512), [
                          [vModelSelect, unref(quickDownloadMethod).value]
                        ]),
                        _cache[20] || (_cache[20] = createElementVNode("p", null, [
                          createTextVNode(' *Notice: If you had changed the Archiver Settings, you have to change it back to "Manual Select, Manual Start (Default)" in the setting page: '),
                    ...
                    createElementVNode("div", _hoisted_8, [
                      createVNode(ToggleSwitch, {
                        modelValue: unref(loadAllGalleryImagesSwitch).value,
                        "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => unref(loadAllGalleryImagesSwitch).value = $event)
                      }, null, 8, ["modelValue"]),
                      _cache[22] || (_cache[22] = createElementVNode("h3", { class: "settings__name" }, " Load All Gallery Images ", -1))
                    ])
                  ]),
                  createElementVNode("section", _hoisted_9, [
                    _cache[29] || (_cache[29] = createElementVNode("h2", { class: "settings-panel__section-name" }, " Multi-Page Viewer Enhancer ", -1)),
                    _cache[30] || (_cache[30] = createElementVNode("hr", null, null, -1)),
                    createElementVNode("div", _hoisted_10, [
                      createVNode(ToggleSwitch, {
                        modelValue: unref(multipageViewerEnhancerSwitch).value,
                        "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => unref(multipageViewerEnhancerSwitch).value = $event)
                      }, null, 8, ["modelValue"]),
                      _cache[25] || (_cache[25] = createElementVNode("h3", { class: "settings__name" }, " Multi-Page Viewer Enhancer ", -1))
                    ]),
                    createElementVNode("div", _hoisted_11, [
                      createVNode(ToggleSwitch, {
                        modelValue: unref(preventImageRemovalSwitch).value,
                        "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => unref(preventImageRemovalSwitch).value = $event)
                      }, null, 8, ["modelValue"]),
                      _cache[26] || (_cache[26] = createElementVNode("h3", { class: "settings__name" }, " Prevent Image Removal ", -1)),
                      _cache[27] || (_cache[27] = createElementVNode("div", { class: "settings__intro" }, [
                        createElementVNode("p", null, " The original script of exhentai would remove the images which are too far from your current scroll. "),
                        createElementVNode("p", null, " So if you scroll back to the images that have been removed. It might be flashing because although your browser has cached the image but still have to re-render it. ")
                      ], -1))
                    ]),
                    createElementVNode("div", _hoisted_12, [
                      createVNode(ToggleSwitch, {
                        modelValue: unref(autoRedirectSwitch).value,
                        "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => unref(autoRedirectSwitch).value = $event)
                      }, null, 8, ["modelValue"]),
                      _cache[28] || (_cache[28] = createElementVNode("h3", { class: "settings__name" }, " Auto Redirect to Multi-Page Viewer ", -1))
                    ])
                  ]),
                  createElementVNode("section", _hoisted_13, [
                    _cache[37] || (_cache[37] = createElementVNode("h2", { class: "settings-panel__section-name" }, " Front Page Enhancer ", -1)),
                    _cache[38] || (_cache[38] = createElementVNode("hr", null, null, -1)),
                    createElementVNode("div", _hoisted_14, [
                      createVNode(ToggleSwitch, {
                        modelValue: unref(infiniteScrollSwitch).value,
                        "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => unref(infiniteScrollSwitch).value = $event)
                      }, null, 8, ["modelValue"]),
                      _cache[31] || (_cache[31] = createElementVNode("h3", { class: "settings__name" }, " Infinite Scroll ", -1))
                    ]),
                    createElementVNode("div", _hoisted_15, [
                      createVNode(ToggleSwitch, {
                        modelValue: unref(scrollByRowSwitch).value,
                        "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => unref(scrollByRowSwitch).value = $event)
                      }, null, 8, ["modelValue"]),
                      _cache[32] || (_cache[32] = createElementVNode("h3", { class: "settings__name" }, " Scroll by Row ", -1)),
                      _cache[33] || (_cache[33] = createElementVNode("span", { class: "settings__notice" }, ' *sync with "Gallery Enhancer - Scroll by Row" ', -1))
                    ]),
                    createElementVNode("div", _hoisted_16, [
                      createVNode(ToggleSwitch, {
                        modelValue: unref(highlightSwitch).value,
                        "onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => unref(highlightSwitch).value = $event)
                      }, null, 8, ["modelValue"]),
                      _cache[34] || (_cache[34] = createElementVNode("h3", { class: "settings__name" }, " Highlight downloaded gallery ", -1)),
                      _cache[35] || (_cache[35] = createElementVNode("div", { class: "settings__intro" }, " Set background color of downloaded Gallery color to black. ", -1))
                    ]),
                    createElementVNode("div", _hoisted_17, [
                      createVNode(ToggleSwitch, {
                        modelValue: unref(archiveButtonSwitch).value,
                        "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => unref(archiveButtonSwitch).value = $event)
                      }, null, 8, ["modelValue"]),
                      _cache[36] || (_cache[36] = createElementVNode("h3", { class: "settings__name" }, " Insert archiver buttons to galleries on the front page. ", -1))
                    ])
                  ])
                ]),
      ...
      function getGalleryIDandToken(pathname) {
        var _a;
        const groups = (_a = pathname.match(/(mpv|g)\/(?<id>\d+)\/(?<token>\w+)/)) == null ? void 0 : _a.groups;
        if (!groups) {
          return {
            id: null,
            token: null
      ...
      const _sfc_main = /* @__PURE__ */ defineComponent({
        ...
        setup(__props) {
          ...
          function useEnhancer() {
            const enhancer2 = computed(() => {
              if (/https:\/\/e[-x]hentai\.org\/(watched|popular)?(\?.+)?$/.test(href) || /https:\/\/e[-x]hentai\.org\/(tag)\/\w+/.test(href)) {
                return defineAsyncComponent(() => __vitePreload(() => module.import('./FrontPageEnhancer-BALXLlfv-UQSrdl_P.js'), void 0 ));
              }
              if (/https:\/\/e[-x]hentai\.org\/g\/\w+\/\w+/.test(href)) {
                return defineAsyncComponent(() => __vitePreload(() => module.import('./GalleryEnhancer-CGaj2fYz-CZJi1wI4.js'), void 0 ));
              }
              if (multipageViewerEnhancerSwitch.value && /https:\/\/e[-x]hentai\.org\/mpv\/\w+\/\w+/.test(href)) {
                return defineAsyncComponent(() => __vitePreload(() => module.import('./MultiPageViewerEnhancer-w4Ylya_m-B159B_XV.js'), void 0 ));
              }
              return null;
            });
            return {
          ...
          return (_ctx, _cache) => {
            return openBlock(), createElementBlock(Fragment, null, [
              (openBlock(), createBlock(Suspense, null, {
                default: withCtx(() => [
                  (openBlock(), createBlock(resolveDynamicComponent(unref(enhancer))))
                ]),
                _: 1
              })),
...
System.register("./FrontPageEnhancer-BALXLlfv-UQSrdl_P.js", ['vue', './__monkey.entry-BFKvEyld.js', './useWheelStep-C8UnhEHF-1C49EO_W.js', './useArchive-a1e3l1kv-DzF9TvS7.js'], (function (exports, module) {
  'use strict';
  var defineComponent, ref, computed, openBlock, createBlock, unref, mergeProps, withCtx, createElementVNode, normalizeStyle, scrollByRowSwitch, infiniteScrollSwitch, getElement, getElements, getDoc, useElementBounding, archiveButtonSwitch, quickDownloadMethod, DownloadMethod, Ro, getArchiveLink, useWheelStep, useFetchPopups, useArchive, useHighlight;
  return {
    setters: [module => {
      defineComponent = module.defineComponent;
      ref = module.ref;
      ...
      scrollByRowSwitch = module.s;
      infiniteScrollSwitch = module.i;
      getElement = module.g;
      getElements = module.a;
      getDoc = module.b;
      useElementBounding = module.u;
      archiveButtonSwitch = module.c;
      quickDownloadMethod = module.q;
      DownloadMethod = module.D;
      Ro = module.R;
      getArchiveLink = module.d;
    }, module => {
      useWheelStep = module.u;
    }, module => {
      useFetchPopups = module.u;
      useArchive = module.a;
      useHighlight = module.b;
    }],
    execute: (function () {
      ...
      const _sfc_main = exports("default", /* @__PURE__ */ defineComponent({
        ...
        setup(__props) {
          ...
          function useInfiniteScroll({
            ...
            const bottomPagination = (_a = getElements(".searchnav")) == null ? void 0 : _a[1];
            ...
            const intersectionObserver = new IntersectionObserver(async ([bottomPagination2]) => {
              ...
              nextPageUrl = (_a2 = getElement("#dnext", doc)) == null ? void 0 : _a2.getAttribute("href");
          ...
          highlightAll();
          return (_ctx, _cache) => {
            return openBlock(), createBlock(unref(Ro), mergeProps({
              ...
              default: withCtx(() => [
                createElementVNode("div", {
                  ...
                  style: normalizeStyle(archivePopupPosition.value),
                  innerHTML: unref(archiveInnerHtml)
                }, null, 12, _hoisted_1)
              ]),
              _: 1
            }, 16, ["modelValue"]);
...
System.register("./GalleryEnhancer-CGaj2fYz-CZJi1wI4.js", ['vue', './__monkey.entry-BFKvEyld.js', './useArchive-a1e3l1kv-DzF9TvS7.js', './useWheelStep-C8UnhEHF-1C49EO_W.js'], (function (exports, module) {
  'use strict';
  var defineComponent, ref, withAsyncContext, computed, onMounted, openBlock, createElementBlock, Fragment, createVNode, unref, mergeProps, withCtx, createElementVNode, normalizeStyle, nextTick, loadAllGalleryImagesSwitch, scrollByRowSwitch, betterPopupSwitch, quickDownloadMethod, DownloadMethod, getElements, _unsafeWindow, Ro, useElementBounding, delay2, getDoc, getElement, Logger, useGalleryElements, useFetchPopups, useArchive, useHighlight, LoggerScopeDecorator, useWheelStep;
  return {
    setters: [module => {
      defineComponent = module.defineComponent;
      ref = module.ref;
      withAsyncContext = module.withAsyncContext;
      computed = module.computed;
      onMounted = module.onMounted;
      openBlock = module.openBlock;
      createElementBlock = module.createElementBlock;
      ...
      loadAllGalleryImagesSwitch = module.l;
      scrollByRowSwitch = module.s;
      betterPopupSwitch = module.e;
      quickDownloadMethod = module.q;
      DownloadMethod = module.D;
      getElements = module.a;
      ...
      Logger = module.L;
      useGalleryElements = module.c;
      useFetchPopups = module.u;
      useArchive = module.a;
      useHighlight = module.b;
      LoggerScopeDecorator = module.d;
    }, module => {
      useWheelStep = module.u;
    }],
    execute: (function () {
      ...
      async function fetchAllImages({ delayInMs = 3e3 }) {
        ...
        function isFirstPage() {
          var _a;
          return ((_a = getElement(".ptds")) == null ? void 0 : _a.innerText) === "1";
        }
        ...
        function appendImages(elements) {
          var _a;
          (_a = getElement("#gdt")) == null ? void 0 : _a.append(...elements);
        }
      }
      function useFavorite(favoriteInnerHtml) {
        ...
        function setRequestEvents(target, popup, isPopupShow) {
          var _a, _b;
          const submitButton = (_a = popup.value) == null ? void 0 : _a.querySelector("input[type=submit]");
          submitButton == null ? void 0 : submitButton.addEventListener("click", async (event) => {
            var _a2;
            event.preventDefault();
            const favoriteCategory = (_a2 = getElement("[name=favcat]:checked")) == null ? void 0 : _a2.value;
          ...
          if (categoryOptions == null ? void 0 : categoryOptions.length) {
            for (const option of categoryOptions) {
              option.addEventListener("dblclick", async (event) => {
                var _a2;
                event.preventDefault();
                const category = (_a2 = option.querySelector("[name=favcat]")) == null ? void 0 : _a2.value;
      ...
      function useTorrent() {
        function downloadTorrent(popup) {
          var _a;
          (_a = getElement("a", popup.value)) == null ? void 0 : _a.click();
        }
        return {
          downloadTorrent
        };
      ...
      const _sfc_main = exports("default", /* @__PURE__ */ defineComponent({
        ...
        async setup(__props) {
          ...
          const archivePopup = ref();
          const torrentPopup = ref();
          const favoritePopup = ref();
          ...
          if (betterPopupSwitch.value) {
            [__temp, __restore] = withAsyncContext(() => preloadLinks()), await __temp, __restore();
            setTimeout(() => {
          ...
          return (_ctx, _cache) => {
            return openBlock(), createElementBlock(Fragment, null, [
              createVNode(unref(Ro), mergeProps({
                modelValue: isArchivePopupShow.value,
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => isArchivePopupShow.value = $event)
              }, modalOptions.value), {
                default: withCtx(() => [
                  createElementVNode("div", {
                    ...
                    ref: archivePopup,
                    class: "popup popup--archive",
                    style: normalizeStyle(unref(archivePosition)),
                    innerHTML: unref(archiveInnerHtml)
                  }, null, 12, _hoisted_1)
                ]),
                _: 1
              ...
              createVNode(unref(Ro), mergeProps({
                ...
                default: withCtx(() => [
                  createElementVNode("div", {
                    ...
                    style: normalizeStyle(unref(torrentPosition)),
                    innerHTML: unref(torrentInnerHtml)
                  }, null, 12, _hoisted_2)
                ]),
                _: 1
              }, 16, ["modelValue"]),
              createVNode(unref(Ro), mergeProps({
                ...
                default: withCtx(() => [
                  createElementVNode("div", {
                    ...
                    ref: favoritePopup,
                    class: "popup",
                    style: normalizeStyle(unref(favoritePosition)),
                    innerHTML: unref(favoriteInnerHtml)
                  }, null, 12, _hoisted_3)
                ]),
                _: 1
              }, 16, ["modelValue"])
...
System.register("./useArchive-a1e3l1kv-DzF9TvS7.js", ['./__monkey.entry-BFKvEyld.js', 'vue'], (function (exports, module) {
  'use strict';
  var useToast, getElement, _GM_getValue, getDoc, highlightSwitch, _GM_setValue, _GM_addValueChangeListener, getElements, quickDownloadMethod, DownloadMethod, ref;
  return {
    setters: [module => {
      useToast = module.h;
      getElement = module.g;
      _GM_getValue = module.j;
      getDoc = module.b;
      highlightSwitch = module.k;
      _GM_setValue = module.m;
      _GM_addValueChangeListener = module.n;
      getElements = module.a;
      quickDownloadMethod = module.q;
      DownloadMethod = module.D;
    }, module => {
    ...
    execute: (function () {
      ...
      } exports("d", LoggerScopeDecorator);
      ...
      const torrentInnerHtml = ref("");
      const archiveInnerHtml = ref("");
      const favoriteInnerHtml = ref("");
      function useFetchPopups() {
        ...
        function getDownloadLink(linkElement) {
          ...
          return (_a = onClick.match(/(https:\/\/\S+)',\d+,\d+/)) == null ? void 0 : _a[1];
        }
      ...
      function useArchive() {
        ...
        function setHentaiAtHomeEvent() {
          ...
          const postUrl = (_a = getElement("#hathdl_form")) == null ? void 0 : _a.getAttribute("action");
          if (!postUrl) {
        ...
        function setDirectDownloadEvent() {
          ...
          for (const button of downloadButtons) {
            button.addEventListener("click", async (event) => {
              var _a;
              event.preventDefault();
              const form = (_a = button == null ? void 0 : button.parentElement) == null ? void 0 : _a.parentElement;
              if (!form) {
        ...
        function setCancelArchiveEvent() {
          ...
          const cancelButton = (_b = (_a = invalidateForm == null ? void 0 : invalidateForm.nextElementSibling) == null ? void 0 : _a.children) == null ? void 0 : _b[2];
          ...
          cancelButton.addEventListener("click", (event) => {
            ...
            fetch(url, {
              ...
              archiveInnerHtml2.value = (_a2 = getElement("#db", html)) == null ? void 0 : _a2.innerHTML;
              setTimeout(() => {
                setDirectDownloadEvent();
              }, 0);
            });
...
System.register("./MultiPageViewerEnhancer-w4Ylya_m-B159B_XV.js", ['vue', './__monkey.entry-BFKvEyld.js', './useWheelStep-C8UnhEHF-1C49EO_W.js'], (function (exports, module) {
  'use strict';
  var ref, defineComponent, onMounted, watch, openBlock, createElementBlock, withModifiers, unref, createVNode, createElementVNode, withKeys, toDisplayString, computed, Fragment, renderList, normalizeClass, useBrowserLocation, getElement, preventImageRemovalSwitch, _unsafeWindow, useFullscreen, _export_sfc, getElements, scrollElement, useStorage, useWheelStep;
  return {
    setters: [module => {
      ref = module.ref;
      defineComponent = module.defineComponent;
      ...
      useBrowserLocation = module.o;
      getElement = module.g;
      preventImageRemovalSwitch = module.p;
      _unsafeWindow = module._;
      useFullscreen = module.r;
      _export_sfc = module.t;
      getElements = module.a;
      scrollElement = module.v;
      useStorage = module.w;
    }, module => {
      useWheelStep = module.u;
    }],
    execute: (function () {
      ...
      const currentPage$1 = ref(Number((_a = location.value.hash) == null ? void 0 : _a.replace("#page", "")) || 1);
      function usePages() {
          ...
          return (_ctx, _cache) => {
            return openBlock(), createElementBlock("div", _hoisted_1$2, [
              createElementVNode("input", {
                ...
                value: unref(currentPage2),
                onKeydown: [
                  _cache[0] || (_cache[0] = withModifiers(() => {
                  }, ["stop"])),
                  _cache[1] || (_cache[1] = withKeys(($event) => unref(goToPage2)(Number($event.target.value)), ["enter"]))
                ]
              }, null, 40, _hoisted_2$1),
              _cache[2] || (_cache[2] = createElementVNode("span", { class: "page-elevator__slash" }, "／", -1)),
              createElementVNode("span", {
                textContent: toDisplayString(unref(pageCount2))
              }, null, 8, _hoisted_3)
            ]);
          };
        }
      });
      const PageElevator = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-c3f8cb4a"]]);
      ...
      const _sfc_main$1 = /* @__PURE__ */ defineComponent({
        ...
        setup(__props) {
          ...
          function useImageResizer() {
            ...
            const currentIndex2 = ref(storedIndex.value);
            watch(currentIndex2, (index) => {
          ...
          return (_ctx, _cache) => {
            return openBlock(), createElementBlock("div", _hoisted_1$1, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(sizeList), (size, index) => {
                return openBlock(), createElementBlock("button", {
                  key: size,
                  class: normalizeClass(["image-resizer__button", { "image-resizer__button--active": index === unref(currentIndex) }]),
                  onClick: ($event) => unref(onResizerClick)(index),
                  textContent: toDisplayString(size)
                }, null, 10, _hoisted_2);
              }), 128))
            ]);
          };
      ...
      const ImageResizer = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-507e1be8"]]);
      const _hoisted_1 = ["innerHTML"];
      const _sfc_main = exports("default", /* @__PURE__ */ defineComponent({
          ...
          return (_ctx, _cache) => {
            return openBlock(), createElementBlock("div", {
              ...
              onWheel: _cache[0] || (_cache[0] = withModifiers(
                //@ts-ignore
                (...args) => unref(changePageOnWheel) && unref(changePageOnWheel)(...args),
                ["stop"]
              ))
            }, [
              createVNode(PageElevator, { class: "enhancer-features__feature" }),
              createVNode(ImageResizer, { class: "enhancer-features__feature" }),
              createElementVNode("div", {
...
System.register("./useWheelStep-C8UnhEHF-1C49EO_W.js", ['./__monkey.entry-BFKvEyld.js'], (function (exports, module) {
  'use strict';
