...
(function(vue, Toast) {
  ...
  const _sfc_main$4 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      vue.useCssVars((_ctx) => ({
        "8ffd7cc4": vue.unref(popupRight),
        "2467ee01": vue.unref(archiveTop),
        "adfeaa1a": vue.unref(torrentTop)
      }));
