...
(function (vue) {
 ...
 Open popup`);
  ...
  function getGalleryIDandToken() {
    var _a3;
    const groups = (_a3 = _unsafeWindow.location.pathname.match(/(mpv|g)\/(?<id>\d+)\/(?<token>\w+)/)) == null ? void 0 : _a3.groups;
    if (!groups) {
      return {
        id: null,
        token: null
